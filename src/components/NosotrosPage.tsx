...
const NosotrosPage: React.FC = () => {
    ...
    return (
        <div className="w-full bg-white dark:bg-slate-900 h-full overflow-y-auto font-['Poppins',_sans-serif]">
            <header className="bg-slate-50 dark:bg-slate-800/50 py-16">
                <div className="max-w-4xl mx-auto px-6 text-center">
                     <AnimateOnScroll>
                        <h1 className="text-4xl md:text-5xl font-bold text-[#1E1E1E] dark:text-slate-100 leading-tight mb-4">
                            Nuestra Historia: Pasión por la Energía Solar
                        </h1>
                        <p className="text-lg md:text-xl text-[#5B5B5B] dark:text-slate-400">
            ...
            <main className="py-20">
                <div className="max-w-4xl mx-auto px-6 space-y-20">
                    ...
                    <section>
                        <AnimateOnScroll>
                            <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-200 mb-8 text-center">El Comienzo del Viaje</h2>
                            <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:h-full before:w-0.5 before:bg-slate-200 before:dark:bg-slate-700 before:content-[''] before:self-start">
                                ...
                                <div className="relative pl-14">
                                    ...
                                    <h3 className="font-bold text-xl text-slate-800 dark:text-slate-200 mb-1">Enero 2023: La Chispa Inicial</h3>
                                    <p className="text-slate-600 dark:text-slate-400">OFFgridRD nació de la curiosidad y la pasión por la tecnología. Su fundador, Eligio Estévez, construyó una PowerWall personal con pilas 18650, un experimento que le abrió las puertas al fascinante mundo de la energía solar, los inversores y los controladores MPPT.</p>
                                </div>
                                ...
                                <div className="relative pl-14">
                                    ...
                                    <h3 className="font-bold text-xl text-slate-800 dark:text-slate-200 mb-1">El Primer Proyecto</h3>
                                    <p className="text-slate-600 dark:text-slate-400">Poco después, un conocido pidió ayuda para instalar 3 paneles bifaciales de 550 W. Este primer trabajo fue un éxito y reveló tanto los retos reales del oficio como la satisfacción de ayudar a otros a aprovechar la energía del sol.</p>
                                </div>
                                ...
                                <div className="relative pl-14">
                                    ...
                                    <h3 className="font-bold text-xl text-slate-800 dark:text-slate-200 mb-1">Mayo 2024: Nace OFFgridRD</h3>
                                    <p className="text-slate-600 dark:text-slate-400">Esa pasión se convirtió en propósito. OFFgridRD se fundó como una empresa dominicana con una misión clara: “Desconéctate de la red.”</p>
                                </div>
                            </div>
                        </AnimateOnScroll>
                    </section>
                    ...
                    <section className="grid md:grid-cols-2 gap-12 items-center">
                        <AnimateOnScroll direction="left">
                            <div className="bg-slate-50 dark:bg-slate-800 p-8 rounded-xl">
                                ...
                                <p className="text-slate-600 dark:text-slate-400">Llevar energía solar accesible, confiable y de calidad a cada hogar dominicano, ayudando a las personas a independizarse de la red eléctrica y disfrutar de una vida más sostenible.</p>
                            </div>
                        </AnimateOnScroll>
                        <AnimateOnScroll direction="right">
                             <div className="bg-slate-50 dark:bg-slate-800 p-8 rounded-xl">
                                <h3 className="text-2xl font-bold text-[#2E8B57] mb-4">Nuestra Visión</h3>
                                <p className="text-slate-600 dark:text-slate-400">Ser la primera opción en República Dominicana cuando alguien piense en instalar paneles solares, reconocidos por nuestra honestidad, calidad y atención personalizada.</p>
                            </div>
                        </AnimateOnScroll>
                    </section>
                    ...
                    <section>
                        <AnimateOnScroll>
                            <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-200 mb-12 text-center">Nuestros Valores</h2>
                        </AnimateOnScroll>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            {values.map((value, index) => (
                                <AnimateOnScroll key={value.title} delay={index * 150} direction="up">
                                    <div className="text-center p-6 bg-slate-50 dark:bg-slate-800 rounded-lg h-full">
                                        <div className="flex items-center justify-center h-16 w-16 rounded-full bg-[#2E8B57]/10 text-[#2E8B57] dark:text-green-400 mx-auto mb-4">
                                            {value.icon}
                                        </div>
                                        <h3 className="font-bold text-lg text-slate-800 dark:text-slate-200 mb-2">{value.title}</h3>
